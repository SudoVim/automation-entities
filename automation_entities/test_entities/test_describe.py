...
class MyEntity(Entity):
    ...
    def my_func(self, a: str, b: str, c: str = "default_c", d: str = "default_d") -> str:
        return f"{a}, {b}, {c}, {d}"
...
class TestDescribe(unittest.TestCase):
    ...
    def test_not_entity(self) -> None:
        ...
        with self.assertRaisesRegex(AssertionError, "received invalid 'self' value type"):
            inner("invalid", "a", "b")
    ...
    def test_kwargs(self) -> None:
        ...
        self.context.subcontext.assert_called_once_with("MyEntity.my_func('a', 'b', c='cval', d='dval'):")
    ...
    def test_too_long(self) -> None:
        ...
        self.context.subcontext.assert_called_once_with("MyEntity.my_func('aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa', 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb...):")
        self.context.log.assert_called_once_with("Return: 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa, bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb...")
