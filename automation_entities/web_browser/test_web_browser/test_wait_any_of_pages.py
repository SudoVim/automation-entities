...
class TestWaitAnyOfPages(WebBrowserTestCase):
    ...
    def test_with_optional(self, try_timeout: MagicMock) -> None:
        self.web_browser.wait_any_of_pages(("/page1", "/page2"), timeout=5.3, baseurl="https://subdomain.example.com")
    ...
    def test_fcn_matches_baseurl(self) -> None:
        ...
        with self.web_browser.result() as result:
            self.web_browser._wait_any_of_pages_fcn(result, ('/page',), baseurl="https://subdomain.example.com")
